...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'blogScience', 'user' => 'root', 'password' => 'admin', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_2a19ebff66f203ee262ca163ceb3dfd5');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_2a19ebff66f203ee262ca163ceb3dfd5');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_2a19ebff66f203ee262ca163ceb3dfd5');

        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\Blog\\BlogBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Blog\\UserBundle\\Entity')));
        ...
        $g->addDriver($e, 'Blog\\BlogBundle\\Entity');
        $g->addDriver($e, 'Blog\\UserBundle\\Entity');
        $g->addDriver($f, 'FOS\\UserBundle\\Entity');

        $h = new \Doctrine\ORM\Configuration();
        $h->setEntityNamespaces(array('BlogBundle' => 'Blog\\BlogBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'BlogUserBundle' => 'Blog\\UserBundle\\Entity'));
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), 'b1e1016537e529147e2272a36ca3d3582');
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Blog\\BlogBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('b1e1016537e529147e2272a36ca3d3582');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'locale' => 'fr',
            'secret' => 'b1e1016537e529147e2272a36ca3d3582',
            ...
            'kernel.secret' => 'b1e1016537e529147e2272a36ca3d3582',
