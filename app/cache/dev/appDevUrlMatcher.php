...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (preg_match('#^/(?P<page>\\d+)?$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'blog_homepage')), array (  '_controller' => 'Blog\\BlogBundle\\Controller\\PublicController::indexAction',  'page' => 1,));
        }
        ...
        // page_categorie
        if (0 === strpos($pathinfo, '/Categorie') && preg_match('#^/Categorie/(?P<id>\\d+)/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
